...
class KconfigCheck(ComplianceTest):
    ...
    def run(self, full=True, no_modules=False, hwm_scheme="v*", filename="Kconfig"):
        self.no_modules = no_modules

        kconf = self.parse_kconfig(hwm_scheme=hwm_scheme, filename=filename)
    ...
    def parse_kconfig(self, hwm_scheme="v*", filename="Kconfig"):
        """
        ...
        os.environ["HWM_SCHEME"] = hwm_scheme
        os.environ["BOARD"] = "*"
        os.environ["ARCH"] = "*"
...
class KconfigBoardV2Check(KconfigCheck, ComplianceTest):
    ...
    def run(self):
        ...
        super().run(full=False, hwm_scheme="v2", filename=kconfig_file)
