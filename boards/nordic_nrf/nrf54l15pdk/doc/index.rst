...
The ``nrf54l15pdk/nrf54l15_enga/cpuapp`` board configuration supports the following
hardware features:
...
Applications for the ``nrf54l15pdk/nrf54l15_enga/cpuapp`` board can be
...
.. zephyr-app-commands::
   ...
   :board: nrf54l15pdk/nrf54l15_enga/cpuapp
   :goals: build flash
