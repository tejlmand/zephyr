...
if(EXISTS ${DTS_SOURCE})
  ...
  if(DEFINED BOARD_REVISION AND EXISTS ${BOARD_DIR}/${dts_board_string}_${BOARD_REVISION_STRING}.overlay)
    list(APPEND DTS_SOURCE ${BOARD_DIR}/${dts_board_string}_${BOARD_REVISION_STRING}.overlay)
  endif()
else()
