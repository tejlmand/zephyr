...
if(NOT (REVISION_SEPARATOR_INDEX EQUAL -1 OR IDENTIFIER_SEPARATOR_INDEX EQUAL -1))
  if(REVISION_SEPARATOR_INDEX GREATER IDENTIFIER_SEPARATOR_INDEX)
    message(FATAL_ERROR "Invalid revision / variant format, format is: <board>@<revision>/<variant>")
  endif()
endif()
...
if(NOT BOARD_DIR)
  ...
  execute_process(${list_boards_commands} --board=${BOARD}
    --cmakeformat={NAME}\;{DIR}\;{HWM}\;{REVISION_FORMAT}\;{REVISION_DEFAULT}\;{REVISIONS}\;{IDENTIFIERS}
                  OUTPUT_VARIABLE ret_board
                  ERROR_VARIABLE err_board
                  RESULT_VARIABLE ret_val
  )
  ...
  cmake_parse_arguments(BOARD "" "NAME;DIR;HWM;REVISION_FORMAT;REVISION_DEFAULT" "REVISIONS;IDENTIFIERS" ${ret_board})
...
if(DEFINED BOARD_IDENTIFIER)
  set(board_message "${board_message}, variant: ${BOARD_IDENTIFIER}")
endif()
