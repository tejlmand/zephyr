...
zephyr_linker_section(NAME init KVMA RAM LMA FLASH)
...
if(CONFIG_GEN_SW_ISR_TABLE AND NOT CONFIG_DYNAMIC_INTERRUPTS)
  ...
  zephyr_linker_section(NAME sw_isr_table KVMA FLASH LMA FLASH SUBALIGN ${CONFIG_ARCH_SW_ISR_TABLE_ALIGN} NOINPUT)
...
zephyr_linker_section(NAME initlevel_error KVMA RAM LMA FLASH NOINPUT)
...
if(CONFIG_CPLUSPLUS)
  zephyr_linker_section(NAME ctors KVMA RAM LMA FLASH NOINPUT)
  #
...
if(CONFIG_NET_SOCKETS)
  zephyr_iterable_section(NAME net_socket_register KVMA RAM LMA FLASH SUBALIGN 4)
endif()


if(CONFIG_NET_L2_PPP)
  zephyr_iterable_section(NAME ppp_protocol_handler KVMA RAM LMA FLASH SUBALIGN 4)
endif()

zephyr_iterable_section(NAME bt_l2cap_fixed_chan KVMA RAM LMA FLASH SUBALIGN 4)

if(CONFIG_BT_BREDR)
  zephyr_iterable_section(NAME bt_l2cap_br_fixed_chan KVMA RAM LMA FLASH SUBALIGN 4)
endif()

zephyr_iterable_section(NAME bt_gatt_service_static KVMA RAM LMA FLASH SUBALIGN 4)

if(CONFIG_BT_MESH)
  zephyr_iterable_section(NAME bt_mesh_subnet_cb KVMA RAM LMA FLASH SUBALIGN 4)
  zephyr_iterable_section(NAME bt_mesh_app_key_cb KVMA RAM LMA FLASH SUBALIGN 4)

  zephyr_iterable_section(NAME bt_mesh_hb_cb KVMA RAM LMA FLASH SUBALIGN 4)
endif()

if(CONFIG_BT_MESH_FRIEND)
  zephyr_iterable_section(NAME bt_mesh_friend_cb KVMA RAM LMA FLASH SUBALIGN 4)
endif()

if(CONFIG_BT_MESH_LOW_POWER)
  zephyr_iterable_section(NAME bt_mesh_lpn_cb KVMA RAM LMA FLASH SUBALIGN 4)
endif()

if(CONFIG_BT_MESH_PROXY)
  zephyr_iterable_section(NAME bt_mesh_proxy_cb KVMA RAM LMA FLASH SUBALIGN 4)
endif()

if(CONFIG_EC_HOST_CMD)
  zephyr_iterable_section(NAME ec_host_cmd_handler KVMA RAM LMA FLASH SUBALIGN 4)
endif()

if(CONFIG_SETTINGS)
  zephyr_iterable_section(NAME settings_handler_static KVMA RAM LMA FLASH SUBALIGN 4)
endif()

zephyr_iterable_section(NAME k_p4wq_initparam KVMA RAM LMA FLASH SUBALIGN 4)
...
if(CONFIG_DNS_SD)
  zephyr_iterable_section(NAME dns_sd_rec KVMA RAM LMA FLASH SUBALIGN 4)
endif()
...
zephyr_linker_section(NAME log_strings KVMA RAM LMA FLASH NOINPUT)
zephyr_linker_section_configure(SECTION log_strings INPUT ".log_strings*" KEEP SORT NAME)
# GROUP_ROM_LINK_IN(RAMABLE_REGION, ROMABLE_REGION)

zephyr_linker_section(NAME log_const KVMA RAM LMA FLASH NOINPUT)
zephyr_linker_section_configure(SECTION log_const INPUT ".log_const_*" KEEP SORT NAME)
# GROUP_ROM_LINK_IN(RAMABLE_REGION, ROMABLE_REGION)

zephyr_linker_section(NAME log_backends KVMA RAM LMA FLASH NOINPUT)
zephyr_linker_section_configure(SECTION log_backends INPUT ".log_backends.*" KEEP)
# GROUP_ROM_LINK_IN(RAMABLE_REGION, ROMABLE_REGION)

zephyr_iterable_section(NAME shell KVMA RAM LMA FLASH SUBALIGN 4)

zephyr_linker_section(NAME shell_root_cmds KVMA RAM LMA FLASH NOINPUT)
zephyr_linker_section_configure(SECTION shell_root_cmds INPUT ".shell_root_cmd_*" KEEP SORT NAME)
# GROUP_ROM_LINK_IN(RAMABLE_REGION, ROMABLE_REGION)

zephyr_linker_section(NAME font_entry KVMA RAM LMA FLASH NOINPUT)
zephyr_linker_section_configure(SECTION font_entry INPUT "._cfb_font.*" KEEP SORT NAME)
# GROUP_ROM_LINK_IN(RAMABLE_REGION, ROMABLE_REGION)

zephyr_iterable_section(NAME tracing_backend KVMA RAM LMA FLASH SUBALIGN 4)

zephyr_linker_section(NAME zephyr_dbg_info KVMA RAM LMA FLASH NOINPUT)
zephyr_linker_section_configure(SECTION font_entry INPUT ".zephyr_dbg_info" KEEP)
# GROUP_ROM_LINK_IN(RAMABLE_REGION, ROMABLE_REGION)

zephyr_linker_section(NAME device_handles KVMA RAM LMA FLASH NOINPUT)
