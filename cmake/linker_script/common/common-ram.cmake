...
zephyr_linker_section(NAME device GROUP DATA_REGION)
...
zephyr_linker_section(NAME initshell GROUP DATA_REGION NOINPUT)
...
zephyr_iterable_section(NAME _static_thread_data GROUP DATA_REGION SUBALIGN 4)
...
#
zephyr_iterable_section(NAME k_timer GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_timer, 4)
zephyr_iterable_section(NAME k_mem_slab GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_mem_slab, 4)
zephyr_iterable_section(NAME k_mem_pool GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_mem_pool, 4)
zephyr_iterable_section(NAME k_heap GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_heap, 4)
zephyr_iterable_section(NAME k_mutex GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_mutex, 4)
zephyr_iterable_section(NAME k_stack GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_stack, 4)
zephyr_iterable_section(NAME k_msgq GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_msgq, 4)
zephyr_iterable_section(NAME k_mbox GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_mbox, 4)
zephyr_iterable_section(NAME k_pipe GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_pipe, 4)
zephyr_iterable_section(NAME k_sem GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_sem, 4)
zephyr_iterable_section(NAME k_queue GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_queue, 4)
zephyr_iterable_section(NAME k_condvar GROUP DATA_REGION SUBALIGN 4)
#	Z_ITERABLE_SECTION_RAM_GC_ALLOWED(k_condvar, 4)

zephyr_linker_section(NAME _net_buf_pool_area GROUP DATA_REGION NOINPUT SUBALIGN 4)
