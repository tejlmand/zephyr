...
zephyr_linker_section_configure(SECTION init INPUT ".z_init_PRE_KERNEL_1?_"
...
zephyr_linker_section_configure(SECTION init INPUT ".z_init_PRE_KERNEL_1??_" KEEP SORT NAME)

zephyr_linker_section_configure(SECTION init INPUT ".z_init_PRE_KERNEL_2?_"
  KEEP SORT NAME SYMBOLS __init_PRE_KERNEL_2_start)
zephyr_linker_section_configure(SECTION init INPUT ".z_init_PRE_KERNEL_2??_" KEEP SORT NAME)

zephyr_linker_section_configure(SECTION init INPUT ".z_init_POST_KERNEL_2?_"
  KEEP SORT NAME SYMBOLS __init_POST_KERNEL_start)
zephyr_linker_section_configure(SECTION init INPUT ".z_init_POST_KERNEL_2??_" KEEP SORT NAME)

zephyr_linker_section_configure(SECTION init INPUT ".z_init_APPLICATION?_"
  KEEP SORT NAME SYMBOLS __init_APPLICATION_start)
zephyr_linker_section_configure(SECTION init INPUT ".z_init_APPLICATION??_" KEEP SORT NAME)

zephyr_linker_section_configure(SECTION init INPUT ".z_init_SMP?_"
  KEEP SORT NAME SYMBOLS __init_SMP_start)
zephyr_linker_section_configure(SECTION init INPUT ".z_init_SMP??_" KEEP SORT NAME)
...
# Pass 2
#zephyr_linker_section_configure(SECTION device_handles INPUT .__device_handles_pass2* KEEP SORT NAME)
# Pass 1
zephyr_linker_section_configure(SECTION device_handles INPUT .__device_handles_pass1* KEEP SORT NAME)
# GROUP_ROM_LINK_IN(RAMABLE_REGION, ROMABLE_REGION)
